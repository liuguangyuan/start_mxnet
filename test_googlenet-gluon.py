...
class Inception(nn.Block):
    ...
    def forward(self, x):
        p1 = self.p1_conv_1(x)
        p2_1 = self.p2_conv_1(x)
        p2_3 = self.p2_conv_3(p2_1)
        p3_1 = self.p3_conv_1(x)
        p3_5 = self.p3_conv_5(p3_1)
        p4_3 = self.p4_pool_3(x)
        p4_1 = self.p4_conv_1(p4_3)
        ret = nd.concat(p1, p2_3, p3_5, p4_1, dim=1)
        return ret
